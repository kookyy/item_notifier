...
If you think something needs to be added, changed, or removed to/from the wiki, please see [Submitting Issues](https://github.com/rScanner/rScanner/blob/master/README.md#submitting-issues) and submit an issue with the "Wiki" tag.
